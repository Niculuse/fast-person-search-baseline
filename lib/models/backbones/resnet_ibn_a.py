...
def resnet50_ibn_a(last_stride, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['resnet50_ibn_a'], map_location='cpu'))
    return model
...
def resnet101_ibn_a(last_stride, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['resnet101_ibn_a'], map_location='cpu'))
    return model
...
def resnet152_ibn_a(last_stride, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['resnet152'], map_location='cpu'))
    return model
